...

{
    public partial class MainPage : ContentPage
    {
        ...
        public MainPage()
        {
            ...
            btnOnOff.Source = ImageSource.FromResource("AppLanterna.Imagens.off.jpg");
            btnOnOff.Source = ImageSource.FromResource("AppLanterna.Imagens.on.jpg");
        ...
        private async void Carrega_Informacoes_Bateria()
        {
            try
            {
                ...
                {
                    lbl_bateria_fraca.Text = "As informãções sobre a bateria não estão disponiveis";
                }
            }
